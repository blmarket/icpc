...
// BEGIN CUT HERE
	...
	void test_case_3() { int Arr0[] = {4, 16, 16, 16, 16,16,16,16,16,16,16,16,16}; vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arg1 = 2; verify_case(3, Arg1, find(Arg0)); }
