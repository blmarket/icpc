...
// BEGIN CUT HERE
	...
	void test_case_1() { int Arr0[] = 
            {5, 9, 11, 7, 11, 0, 1, 14, 4, 7, 10, 11, 9, 8};
            

            
             vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arr1[] = 
            {1, 8, 14, 3, 6, 6, 9, 13, 12, 2, 9, 4, 6, 7};
            
            
            
            
            vector <int> Arg1(Arr1, Arr1 + (sizeof(Arr1) / sizeof(Arr1[0]))); int Arg2 = 4; verify_case(1, Arg2, getmax(Arg0, Arg1)); }
